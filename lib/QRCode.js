...
//-----------------------Methods-----------------------
  ...
  //Returns an array of SVG Elements that represent the pieces of the QR Code
     ...
     if(this.props.backgroundImage){
       return (
          <View style={{backgroundColor:'white',margin:this.props.padding*xsize}}>
            <Image source={this.props.backgroundImage} style={{position:'absolute',top:(this.props.padding*ysize),
            left:(this.props.padding*xsize),height:(this.props.size-this.props.padding*2*ysize),
   ...
   displayLogo(){
     if(this.props.logo){
       return(
          <Image source={this.props.logo} style={{width: this.props.logoSize,
           height: this.props.logoSize, position: 'absolute',
